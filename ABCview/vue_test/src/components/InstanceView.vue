  ...
  methods: {
    ...
    drawAll() {
      ...
      for (let row_idx = 0; row_idx < 10; row_idx++){
          ...
          var rank_lineLength = this.drawParagraph(this.rank_tokens[row_idx], rank_svg, cell_width*1.2, rank_s)
      ...
      for (let row_idx = 0; row_idx < 10; row_idx++){
          ...
          var span_lineLength = this.drawParagraph(this.span_tokens[row_idx], span_svg, cell_width*1.2, span_s)
      ...
      for (let row_idx = 0; row_idx < 10; row_idx++){
          ...
          .attr("y2", margin.top + bar_chart_height + this.order_result[row_idx]*height+8);  
          ...
          .style('stroke', "black")
          .on("mouseover",()=>{
            d3.selectAll(".rect"+this.order_result.indexOf(row_idx)).style('fill', "#333333")
          })
          .on("mouseleave",()=>{
